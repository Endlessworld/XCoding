...
public class ModelRetryInterceptor extends ModelInterceptor {
        ...
        for (int attempt = 1; attempt <= maxAttempts; attempt++) {
            try {
                if (attempt > 1) {
                    ...
                    AcpNotifyHelper.sendProgress(runnableConfig, "Retry model call, on the %s th attempt (out of %s attempts).".formatted(attempt, maxAttempts));
                }
                ...
                if (attempt > 1) {
					AcpNotifyHelper.sendProgress(runnableConfig, "The model call succeeded after the %sth attempt".formatted(attempt));
    ...
    public static class Builder {
        ...
        public Builder runnableConfig(RunnableConfig runnableConfig) {
