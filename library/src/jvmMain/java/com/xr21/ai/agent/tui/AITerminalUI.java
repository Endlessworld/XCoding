...
//
//        Flux<AgentOutput<Object>> outputFlux = localAgent.toFlux(supervisorAgent, input, currentSessionId, interruptionMetadata.get(), stateUpdate);
//
//        // 使用异步订阅，避免阻塞UI线程
//        outputFlux.doOnNext(output -> {
//            AgentOutput<Object> agentOutput = output;
//            // 处理流式文本输出
