...
data class TuiTheme(
    ...
    // 渐变边框配置
    val gradientInfo: GradientColors,
    val gradientChat: GradientColors,
    val gradientInput: GradientColors,
...
fun modernDarkTheme(): TuiTheme = TuiTheme(
    ...
    gradientInfo = GradientColors.CYAN_TO_PURPLE,
    gradientChat = GradientColors.GREEN_TO_CYAN,
    gradientInput = GradientColors.ORANGE_TO_PINK,
